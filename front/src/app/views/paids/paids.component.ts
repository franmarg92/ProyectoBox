...
export class PaidsComponent implements OnInit {
  ...
  constructor(private usersService: UsersService, private paidsService: PaidsService) {}

  ngOnInit(): void {
    this.loadUsers();
    this.selectedUser = Number(localStorage.getItem('selectedUserId')) || 0;
  }
 ...
 loadUsers(): void {
  ...
  calculateExpiration(): void {
    ...
    this.expirationDate = new Date(paymentDate.setMonth(paymentDate.getMonth() + this.monthsPaid));
  }
